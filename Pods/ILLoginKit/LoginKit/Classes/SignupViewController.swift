...
protocol SignupViewControllerDelegate: class {
    ...
    func didSelectSignup(_ viewController: UIViewController, email: String, name: String, password: String, phoneNumber: String)
...
class SignupViewController: UIViewController, KeyboardMovable, BackgroundMovable {
    ...
    func configureFromSource() {
        ...
        phoneTextField.placeholder = config.phonePlaceholder
        phoneTextField.errorColor = config.errorTintColor
    ...
    func setupFonts() {
        ...
        phoneTextField.font = Font.montserratRegular.get(size: 13)
    ...
    @IBAction func didSelectSignup(_ sender: AnyObject) {
        ...
        validateFields {
            delegate?.didSelectSignup(self, email: email, name: name, password: password, phoneNumber: phoneNumber)
        }
    }
...
extension SignupViewController {
    ...
    func setupValidation() {
        ...
        setupValidationOn(field: phoneTextField, rules: ValidationService.phoneNumberRules)
