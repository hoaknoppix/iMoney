...
protocol ConfigurationSource: class {
    ...
    var shouldShowLoginWithFacebook: Bool { get }
...
open class LoginCoordinator: ConfigurationSource {
    ...
    public var shouldShowLoginWithFacebook = true
    
    public var phonePlaceholder: String = "Phone Number"
    ...
    open func signup(name: String, email: String, password: String, phoneNumber: String) {
